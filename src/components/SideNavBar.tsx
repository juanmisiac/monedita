...
export const SideNavBar = () => {
  ...
  return (
    <aside className={`h-screen ${expanded ? "w-72" : "w-18"} duration-150 sm:shadow-md z-30`}>
      <nav className={`h-full flex flex-col sm:bg-white/80 sm:dark:bg-black sm:border-r sm:border-neutral-300 sm:dark:border-neutral-800 ${expanded ? "bg-white/80 dark:bg-black/80 backdrop-blur-md" : ""}`}>
        <div className='p-4 pb-2 flex justify-between items-center text-blue-500 dark:text-white font-medium'>
          ...
          <button
            className='p-1.5 rounded-lg bg-white dark:bg-black border border-neutral-300 dark:border-neutral-700 dark:hover:border-neutral-600 duration-150 hover:border-neutral-400 shadow-xl'
