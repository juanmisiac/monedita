...
//Codigo copiado de tutorial de Fazt Code, buscar: React y TailwindCSS - Dark Theme, cambio de tema
...
export const Header = () => {
  ...
  return (
    <div className="bg-sky-500 dark:bg-slate-900 p-5 flex justify-between items-center">
      <h1 className="text-4xl text-white font-black font-default">🪙Monedita</h1>
      <nav>
        <ul className="flex items-center">
          <li>
            <button
              className="mx-2 px-4 py-2 bg-sky-700 dark:bg-sky-100 hover:bg-sky-900 dark:hover:bg-sky-300 duration-150 rounded text-white dark:text-black"
          ...
          <li>
            <a href="https://github.com/juanmisiac" target="_blank" rel="noopener noreferrer">
              <button className="mx-4" aria-label="GitHub">
                <svg className="text-sky-700 dark:text-sky-100 hover:text-sky-900 dark:hover:text-sky-300" width="30" height="30" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
