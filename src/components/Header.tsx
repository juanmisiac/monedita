    ...
    <div className="bg-white dark:bg-slate-900 border-b border-neutral-200 p-3 md:p-4 flex justify-between items-center">
      ...
      <nav>
        <ul className="flex items-center">
          <li className="">
            <button
              className="p-1 me-2 shadow-md border border-neutral-300 rounded-xl text-blue-500 hover:border-neutral-400 hover:scale-105 duration-100"
          ...
          <li>
            <a href="https://github.com/juanmisiac" target="_blank" rel="noopener noreferrer">
              <button className="p-1 me-2 shadow-md border border-neutral-300 rounded-xl hover:border-neutral-400 hover:scale-105 duration-100" aria-label="GitHub">
                <svg className="text-blue-500" width="30" height="30" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <li>
            <a href="https://www.linkedin.com/in/juan-misiac/" target="_blank" rel="noopener noreferrer">
              <button className="p-1 shadow-md border border-neutral-300 rounded-xl hover:border-neutral-400 hover:scale-105 duration-100" aria-label="LinkedIn">
                <svg className="text-blue-500" width="30" height="30" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
