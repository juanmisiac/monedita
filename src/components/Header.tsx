...
export const Header = () => {
  ...
  return (
    <div className="bg-blue-400 dark:bg-blue-950 p-3 md:p-4 flex justify-between items-center">
      <h1 className="text-xl sm:text-2xl md:text-3xl text-white font-black font-default hover:cursor-default">🪙Monedita</h1>
      <nav>
          ...
          <li>
            <a href="https://github.com/juanmisiac" target="_blank" rel="noopener noreferrer">
              <button className="ms-1 md:ms-2 me-3 md:me-4 mt-1" aria-label="GitHub">
                <svg className="duration-150 text-white hover:text-yellow-400" width="28" height="28" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
