...
export const Header = () => {
  ...
  return (
    <div className="bg-slate-100 dark:bg-black border-b border-neutral-300 dark:border-neutral-800 p-3 md:p-4 flex justify-between items-center">
      <h1 className="text-3xl font-black font-default hover:cursor-default">
      ...
      <nav>
        <ul className="flex items-center">
          <li className="">
            <button
              className="p-1 me-2 shadow-md border border-neutral-300 dark:border-neutral-700 dark:hover:border-neutral-600 rounded-xl text-blue-500 dark:text-white hover:border-neutral-400 hover:scale-105 duration-150"
              onClick={handleChangeTheme}
              aria-label="Cambiar tema">
              {theme == "dark" ? <Sun className="size-7.5" /> : <Moon className="size-7.5" />}
            </button>
          </li>
          <li>
            <a href="https://github.com/juanmisiac" target="_blank" rel="noopener noreferrer">
              <button className="p-1 me-2 shadow-md border border-neutral-300 dark:border-neutral-700 dark:hover:border-neutral-600 rounded-xl hover:border-neutral-400 hover:scale-105 duration-150" aria-label="GitHub">
                <svg className="text-blue-500 dark:text-white" width="30" height="30" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <li>
            <a href="https://www.linkedin.com/in/juan-misiac/" target="_blank" rel="noopener noreferrer">
              <button className="p-1 shadow-md border border-neutral-300 dark:border-neutral-700 dark:hover:border-neutral-600 rounded-xl hover:border-neutral-400 hover:scale-105 duration-150" aria-label="LinkedIn">
                <svg className="text-blue-500 dark:text-white" width="30" height="30" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
