...
export const Header = () => {
  ...
  return (
    <div className="bg-blue-400 dark:bg-blue-950 p-3 flex justify-between items-center">
      <h1 className="text-xl text-white font-black font-default hover:cursor-default">🪙Monedita</h1>
      <nav>
        <ul className="flex items-center">
          ...
          <li>
            <a href="https://github.com/juanmisiac" target="_blank" rel="noopener noreferrer">
              <button className="mx-3 mt-1" aria-label="GitHub">
                <svg className="duration-150 text-white hover:text-yellow-400" width="25" height="25" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <li>
            <a href="https://www.linkedin.com/in/juan-misiac/" target="_blank" rel="noopener noreferrer">
              <button className="mt-1" aria-label="LinkedIn">
                <svg className="duration-150 text-white hover:text-yellow-400" width="25" height="25" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
